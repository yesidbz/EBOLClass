        ...
        formulario(){
            ...
            <Formik
                ...
                {({ errors, touched, values }) => (
                    ...
                    <h1>Detalle programación</h1> 
                       
                      <div className="row">

                      <div className="col-6 form-group">
                          <label>Docente asignatura</label>
                          <Docente_Asignatura_Select default = "id_docente_asignatura={this.state.programacion.id_docente_asignatura}"/>
...
export default DetalleProgramacion;