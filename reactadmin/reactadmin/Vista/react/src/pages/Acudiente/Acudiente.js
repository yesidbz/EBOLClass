...
export default class Acudiente extends Component {
 constructor(props) {
 super(props);
 this.state = {
 acudiente: [],
 ...
 let acudiente = [];
 r.data.forEach(d => {
 const {id, documento, id_tipodocumento, Primer_nombre,segundo_nombre,primer_apellido,segundo_apellido,id_municipio,estado, } = d;
 let obj = {
 id,
 documento,
 id_tipodocumento,
...
detalle(id){
  this.props.history.push(`/Acudiente/detalle/${id}`);
}
