...
export default class AsignarSalon extends Component {
 ...
 <button onClick={()=>this.Pdf(id_grado_grupo_alumno)}  className="btn btn-info" >PDF</button>
...
Pdf(id_grado_grupo_alumno){
  this.props.history.push(`/AsignarSalon/Pdf/${id_grado_grupo_alumno}`);
}
